...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZPTencentIMPod.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zp_crash@163.com/ZPTencentIMPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zp_crash@163.com' => '[zp_crash@163.com]' }
  s.source           = { :git => 'https://github.com/zp_crash@163.com/ZPTencentIMPod.git', :tag => s.version.to_s }
